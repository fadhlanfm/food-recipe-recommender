...
exports.default = _default;
        var $dde651 = exports.default || module.exports;
      
      if (typeof $dde651 === 'function') {
        $dde651 = $dde651.options;
      }
    
        /* template */
        Object.assign($dde651, (function () {
          var render = function() {
  var _vm = this
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "text-center m-5 title-form" }, [
      _c("h1", [_vm._v("Welcome to the Food Recipe Recommendation App")])
    ])
  }
]
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$dde651', $dde651);
          } else {
            api.reload('$dde651', $dde651);
          }
        }
...
var _default = {
  ...
  methods: {
    submitIngredient: function submitIngredient() {
...
exports.default = _default;
        var $927472 = exports.default || module.exports;
      
      if (typeof $927472 === 'function') {
        $927472 = $927472.options;
      }
    
        /* template */
        Object.assign($927472, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "container" }, [
    ...
    _c(
      "form",
      {
        on: {
          submit: function($event) {
            $event.preventDefault()
            return _vm.submitIngredient($event)
          }
        }
      },
      [
        _c("label", { attrs: { for: "1" } }, [_vm._v("Insert ingredient:")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
              name: "model",
              rawName: "v-model",
              value: _vm.newIngredient,
              expression: "newIngredient"
            }
          ],
          attrs: { type: "text", id: "1", placeholder: "e.g.: cheese" },
          domProps: { value: _vm.newIngredient },
          on: {
            input: function($event) {
              if ($event.target.composing) {
                return
              }
              _vm.newIngredient = $event.target.value
            }
          }
        }),
        _vm._v(" "),
    ...
    _c("small", [
      _vm._v(
        "It can be what you have in your kitchen or refrigerator, your favorite ingredients, your grocery wishlist, or any ingredients preferences."
      )
    ]),
    _vm._v(" "),
    _vm.ingredients.length > 0
      ? _c("div", { staticClass: "ingredients-container" }, [
          _c("h2", [
            _vm._v("Ingredients list: "),
            _c("small", [
              _vm._v("(Total: " + _vm._s(_vm.ingredients.length) + ")")
            ])
          ]),
          _vm._v(" "),
          _c(
          ...
          _c("small", [
            _vm._v(
              'Click "recommendation!" button after you finished with your ingredients list'
            )
          ]),
          _c("br"),
          _vm._v(" "),
          _c(
            "button",
            {
              on: {
                click: function($event) {
                  $event.preventDefault()
                  return _vm.getRecommendation($event)
                }
              }
            },
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$927472', $927472);
          } else {
            api.reload('$927472', $927472);
          }
        }
...
exports.default = _default;
        var $f31dd9 = exports.default || module.exports;
      
      if (typeof $f31dd9 === 'function') {
        $f31dd9 = $f31dd9.options;
      }
    
        /* template */
        Object.assign($f31dd9, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.currentPage === "FormLogin"
        ? _c("FormLogin", {
            on: { changePage: _vm.changePage, login: _vm.login }
          })
        : _vm._e(),
      _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f31dd9', $f31dd9);
          } else {
            api.reload('$f31dd9', $f31dd9);
          }
        }
...
},{"./components/FormLogin.vue":"src/components/FormLogin.vue","./components/Dashboard.vue":"src/components/Dashboard.vue","_css_loader":"../../../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/main.js":[function(require,module,exports) {
"use strict";
